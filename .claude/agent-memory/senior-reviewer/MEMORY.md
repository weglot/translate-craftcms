...
- [Open bot findings still on master](open-bot-findings.md) — four findings merged unaddressed; raise at their severity when a diff touches the same code, don't re-raise on unrelated diffs.
