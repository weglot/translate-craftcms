 ...
 */
namespace Weglot\Vendor\Jaybizzle\CrawlerDetect;

use Weglot\Vendor\Jaybizzle\CrawlerDetect\Fixtures\AbstractProvider;
use Weglot\Vendor\Jaybizzle\CrawlerDetect\Fixtures\Crawlers;
use Weglot\Vendor\Jaybizzle\CrawlerDetect\Fixtures\Exclusions;
use Weglot\Vendor\Jaybizzle\CrawlerDetect\Fixtures\Headers;
class CrawlerDetect
{
    /**
     * The user agent.
