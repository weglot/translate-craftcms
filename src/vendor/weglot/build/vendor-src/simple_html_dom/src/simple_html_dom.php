    ...
    protected function seek($selector, &$ret, $lowercase = \false, $direct = \false)
    {
        ...
        for ($i = $index + 1; $i < $end; ++$i) {
            ...
            if ($pass && $key) {
                ...
                } else if ($key != "plaintext" && !isset($node->attr[$key])) {
                    $pass = \false;
                }
            }
            // compare value
...
class simple_html_dom
{
    ...
    protected $optional_closing_tags = array('tr' => array('tr' => 1, 'td' => 1, 'th' => 1), 'th' => array('th' => 1), 'td' => array('td' => 1), 'li' => array('li' => 1), 'dt' => array('dt' => 1, 'dd' => 1), 'dd' => array('dd' => 1, 'dt' => 1), 'dl' => array('dd' => 1, 'dt' => 1), 'p' => array('p' => 1), 'nobr' => array('nobr' => 1), 'b' => array('b' => 1), 'option' => array('option' => 1), 'source' => array('source' => 1));
