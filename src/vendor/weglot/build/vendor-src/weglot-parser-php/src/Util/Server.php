...
{
    /**
     * @var array<string, int> In-memory cache for bot detection results by user agent
     */
    private static $botCache = [];
    /**
     * @var CrawlerDetect|null
     */
    private static $crawlerDetect;
    /**
    ...
    public static function detectBotVe(array $server)
    {
        ...
        return null !== $userAgent && Text::contains($userAgent, 'Weglot Visual Editor');
    }
    /**
     * @param array<string, mixed> $server
     *
