...
class index
{
    ...
    public static function init()
    {
        self::$languages = array_map(function ($language) {
            return ['label' => $language[self::$labelKey], 'value' => $language['code']];
        }, self::sortedJSONArray('available-languages', self::$labelKey));
        self::$cases = ['v1' => self::loadJSON('cases/cases-v1'), 'v2' => self::loadJSON('cases/cases-v2-php'), 'v3' => self::loadJSON('cases/cases-v3')];
