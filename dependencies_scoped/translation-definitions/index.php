...
namespace Weglot\Vendor\Weglot;
...
class TranslationDefinitions
{
    ...
    {
        return json_decode(file_get_contents(__DIR__ . "/data/" . $key . ".json"), \true);
    }
    ...
    static function init()
    {
        self::$languages = array_map(function ($language) {
            return array('label' => $language[self::$labelKey], 'value' => $language['code']);
        }, self::sortedJSONArray("available-languages", self::$labelKey));
        self::$cases = array('v1' => self::loadJSON("cases/cases-v1"), 'v2' => self::loadJSON("cases/cases-v2-php"), 'v3' => self::loadJSON("cases/cases-v3"));
