            ...
            foreach ($slugs as $k => $slug) {
                ...
                foreach ($this->customUrlsByLanguage[$this->currentLanguage->getInternalCode()] as $translatedURL => $originalURL) {
                    if ($slug === $originalURL) {
                        ...
                        $fully_translated_slug_array[] = $translatedURL;
                        // = "301_" . $translatedURL; //If we receive a not translated slug we return a 404. For example if we have /fr/products but should have /fr/produits we should have a 404
                    }
